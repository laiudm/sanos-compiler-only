...
// dcm:     expect(24, strlen(__TIMESTAMP__));
// dcm:     expect(0, __INCLUDE_LEVEL__);
// dcm:     expect_string("test/macro.c", __BASE_FILE__);
// dcm:     expect_string(get_timestamp(), __TIMESTAMP__);
}
