...
static void test_offsetof() {
    struct tag10dcm { int a, b; };
    expect(0, offsetof(struct tag10dcm, a));
    expect(4, offsetof(struct tag10dcm, b));
    int x[offsetof(struct tag10dcm, b)];
...
// dcm:     expect(1, _Alignof(struct { int : 32; }));
// dcm:     expect(2, _Alignof(struct { int : 32; short x; }));
// dcm:     expect(4, _Alignof(struct { int x; int : 32; }));
}
